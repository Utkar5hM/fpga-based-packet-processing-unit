...
HD_PWD='C:/Users/utkar/majorproject/majorproject.runs/mbdesign_axi_uartlite_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mbdesign_axi_uartlite_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mbdesign_axi_uartlite_0_0.tcl
