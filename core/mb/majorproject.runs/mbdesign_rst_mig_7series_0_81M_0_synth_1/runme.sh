...
HD_PWD='C:/Users/utkar/majorproject/majorproject.runs/mbdesign_rst_mig_7series_0_81M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mbdesign_rst_mig_7series_0_81M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mbdesign_rst_mig_7series_0_81M_0.tcl
