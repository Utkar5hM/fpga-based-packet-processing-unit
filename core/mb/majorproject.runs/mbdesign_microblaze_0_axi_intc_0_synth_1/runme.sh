...
HD_PWD='C:/Users/utkar/majorproject/majorproject.runs/mbdesign_microblaze_0_axi_intc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mbdesign_microblaze_0_axi_intc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mbdesign_microblaze_0_axi_intc_0.tcl
