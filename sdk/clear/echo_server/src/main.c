...
u8 ReceiveBuffer[FRAME_BUFFER_SIZE];
volatile u32 TotalReceivedCount;

int main()
{
	int Status;
	XUartLite_Config *CfgPtr;
	Status = XUartLite_Initialize(&UartLite, XUARTLITE_BASEADDRESS);
	...
	XUartLite_Recv(&UartLite, ReceiveBuffer, FRAME_BUFFER_SIZE);
	/*
